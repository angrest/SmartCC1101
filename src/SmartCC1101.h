//****************************************************************
//
//  SmartCC1101.h - CC1101 module library header file
...
public:
  ...
  enum PacketFormat: uint8_t {
	// Synchronous serial mode and Asynchronous serial mode are unsupported
...
private:
  ...
  void writeBurstRegister(uint8_t addr, uint8_t *buffer, uint8_t num, const char* str = __builtin_FUNCTION());
  ...
  uint8_t clb3[2] = { 0x41, 0x46 };
  uint8_t clb4[2] = { 0x4D, 0x4F };
